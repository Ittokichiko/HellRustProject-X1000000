...
{
	[Info("Death Notes", "Terceran/Mr. Blue", "6.4.8")]
	...
	class DeathNotes : RustPlugin
	{
		...
		private void OnEntityDeath(BaseCombatEntity victimEntity, HitInfo hitInfo)
		{
			...
			if (data.VictimEntityType != CombatEntityType.Player && data.KillerEntityType != CombatEntityType.Player &&
				...
				data.KillerEntityType != CombatEntityType.Scientist && data.KillerEntityType != CombatEntityType.HeavyScientist &&
				data.DamageType != DamageType.Drowned)
				return;
			...
			if (
					...
					((data.KillerEntityType == CombatEntityType.Turret || data.KillerEntityType == CombatEntityType.Trap || data.KillerEntityType == CombatEntityType.SAM ||
					  data.KillerEntityType == CombatEntityType.Scientist || data.KillerEntityType == CombatEntityType.HeavyScientist || data.DamageType == DamageType.Drowned) &&
	...
	_instance.Puts($"TERC: {entString}");
				...
				if (Translations.Messages == null)
				{
					Translations.Messages = new List<DeathMessage>
					{
						...
						new("ExcavatorArm", "Player", "*", "A {killer} excavated {victim} for trace amounts of precious materials. None were found."),
						...
						new("Scientist", "*", "*", "{killer} shot down a {victim}."),
						new("HeavyScientist", "*", "*", "{killer} shot down a {victim}."),
						...
						new("*", "Animal", "Drowned", "As the {victim} just found out, breathing underwater is rather difficult."),
